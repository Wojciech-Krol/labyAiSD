...
public interface IList<E> extends Iterable<E> {
    ...
    void add(int index, E element) throws IndexOutOfBoundsException; // add element on position index
    ...
    E remove(int index) throws IndexOutOfBoundsException; // remove element from position index
